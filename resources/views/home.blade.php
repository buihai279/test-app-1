              ...
              <div class="col-sm-4" style="max-height: 310px;margin-bottom:15px;overflow: hidden;">
                  <div class="panel panel-default">
                    <div class="panel-body bg-success" >
                      <img src="{{asset('uploads/'.$product->photo) }}" class="img-responsive" style="height: 200px; margin: 0 auto">
                      <h5 style="height: 30px;overflow: hidden;"><a href="{{ route('detail',$product->id) }}">{{$product->name}}</a></h5>
